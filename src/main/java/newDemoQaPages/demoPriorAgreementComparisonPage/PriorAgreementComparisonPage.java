...
public class PriorAgreementComparisonPage extends NewDemoBasePage {
    ...
    public PriorAgreementComparisonPage() {
        ...
        this.transportationSavings = By.xpath("//div[@class='bg-white shadow-sm rounded savings_box d-flex" +
                " align-items-center mb-4'] //span[contains(@class,'d-block fs-22 fw-semibold')]");
        ...
        this.accountDropdown = By.xpath("//button[@class='custom_select_box d-flex align-items-center " +
                "bg-white text-black dropdown-toggle btn btn-primary']//div[text()='Account Number']");
        this.accountDropdownElements = By.xpath("//div[contains(@class,'dropdown-menu show')]//a");
        this.carrierServiceDropdown = By.xpath("//span[@class='select_icon d-sm-none d-lg-block']");
