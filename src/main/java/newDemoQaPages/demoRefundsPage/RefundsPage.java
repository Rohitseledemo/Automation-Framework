...
public class RefundsPage extends NewDemoBasePage {
    ...
    public RefundsPage(){
        this.carrierServiceDropdown = By.xpath("//button[@class='custom_select_box d-flex align-items-" +
                "center bg-white text-black w-100 dropdown-toggle btn btn-primary']");
        this.carrierServiceDropdownElements = By.xpath("//div[@class='shadow border-0 dropdown-menu show']//a");
        this.accountDropdown = By.xpath("//div[@class='me-3 dropdown']//div[text()='Account Number']");
