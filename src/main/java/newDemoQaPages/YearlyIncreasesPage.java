...
public class YearlyIncreasesPage extends NewDemoBasePage {
    ...
    public YearlyIncreasesPage(){
      ...
      this.serviceDropdown = By.xpath("//button[@class='custom_select_box d-flex align-items-center " +
              "bg-white text-black w-100 dropdown-toggle btn btn-primary']");
      this.serviceDropdownElements = By.xpath("//div[@class='shadow-lg border-0 dropdown-menu show']//a");
    }
